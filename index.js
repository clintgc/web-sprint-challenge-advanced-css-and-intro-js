...
console.log(addArtist(artists, 20, 'Clint Gordon-Carroll', '1979 - current day', 'Startup Design','United States of America', 'Born in South Africa. Immigrated to the United States as a child. Was influenced by tech startups like Microsoft and Novell in the 1980. Sucessfully built and sold Space Monkey.' ))
...
function randomize(array){
  ...
  for (let i = arrayCopy.length; i >= arrayCopy.length && i> 0; i--) {
    start = Math.floor(Math.random() * arrayCopy.length);
